...
public class DateAndTime_02_Test {
	...
	public void test_localDate_parse() {
		...
		LocalDate result = LocalDate.parse("10/01/1990", DateTimeFormatter.ofPattern("dd/MM/uuuu"));
	...
	public void test_localDate_format() {
		...
		String result = localDate.format( DateTimeFormatter.ofPattern("dd - MM - uuuu") );
	...
	public void test_localDate_format_with_hour() {
		...
		localDate.format(  DateTimeFormatter.ofPattern("dd - MM - uuuu HH:mm:ss") );
	}
